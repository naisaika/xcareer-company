...
export const CostSection = () => {
  ...
  return (
    <section className={`${styles.section} ${isVisible ? styles.adjustOpacity : ''}`} id="costSection">
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.cardSection}>
                <Image src="https://www-dev.factorx.jp/xcareercompany/cost/money.png" alt="無料画像" width={240} height={240} priority className={styles.costImg}></Image>
                <CostCard/>
            </div>
        </div>
